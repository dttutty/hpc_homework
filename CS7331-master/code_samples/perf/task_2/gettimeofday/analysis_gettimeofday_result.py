...
dir = '/home/Students/sqp17/hpc_homework/CS7331-master/code_samples/perf/gettimeofday_result/10000_1'
...
print(f"Matrix_vector_mult time: {name}={matrix_mean:.7f}, $\sigma$={matrix_std:.7f}")
print(f"Total execution time: {name}={total_mean:.7f}, $\sigma$={total_std:.7f}")
